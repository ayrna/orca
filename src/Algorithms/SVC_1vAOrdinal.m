classdef SVC_1vAOrdinal < Algorithm
    %SVC_1vAOrdinalOrdinal Support Vector Classifier using 1VsAll approach with ordinal
    % weights
    %   This class derives from the Algorithm Class and implements the
    %   SVC_1vAOrdinalOrdinal method. 
    %   Characteristics: 
    ...
    methods
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %
        % Function: SVC_1vAOrdinalOrdinal (Public Constructor)
        % Description: It constructs an object of the class
        %               SVC_1vAOrdinalOrdinal and sets its characteristics.
        % Type: Void
        % Arguments: 
        ...
        function obj = SVC_1vAOrdinal(kernel)
        ...
        function [model_information] = runAlgorithm(obj,train, test, parameters)
                ...
                model.algorithm = 'SVC_1vAOrdinal';
